...
// IMPORTANT: use Spreadsheet ID (standalone web app has NO active spreadsheet)
const SPREADSHEET_ID = "1vD4CLiI1lPI65I2wvDkYlUw9L_hoe1gIPNpuCj7YrKg";
...
// ==================================================
// ==================================================
// FORCE AUTHORIZE (run this manually in editor once)
// - triggers permission prompt for UrlFetch + Sheets + Drive
// ==================================================
function authorize() {
