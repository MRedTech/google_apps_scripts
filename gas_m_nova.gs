// ==================================================
// SECURE ENTRY - M NOVA (BACKEND - SEARCH + SYNC MIRROR)
// ==================================================
...
const SPREADSHEET_ID_FALLBACK = "1XM2R4rBwJbAQz7MuFPn8yANc18NVClxYrfULrWhwz5A";
const DRIVE_FOLDER_ID = "1g9SbKVU9oDxPCDitGgEBnfldM3tEEwY-";
const SYNC_TOKEN = "MNO_SYNC_9f3c1a7b2d4e6f8091ab3cd5ef678901R";
