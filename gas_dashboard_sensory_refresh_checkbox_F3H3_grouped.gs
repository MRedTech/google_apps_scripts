const DASHBOARD_CONFIG = {
  ...
  filterStartCell: 'B3',
  filterEndCell: 'D3',
  refreshLabelRange: 'G3:H3',
  refreshCheckboxCell: 'F3',
...
function setupRefreshCheckbox_(sheet) {
  // Clear the refresh control area before placing the checkbox and label.
  const refreshArea = sheet.getRange('F3:H3');
  refreshArea
    .breakApart()
    .clearContent()
...
function applyDashboardProtection_() {
  ...
  const protection = sheet.protect().setDescription('Lock dashboard except B3, D3 and F3');
