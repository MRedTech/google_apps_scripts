const DASHBOARD_CONFIG = {
  sourceSheetName: 'M LUNA',
  dashboardSheetName: 'DASHBOARD',
  timezone: 'Asia/Kuala_Lumpur',
  headerTitle: 'SECURE ENTRY | DASHBOARD M LUNA',
...
function buildDashboard() {
  ...
  if (!sourceSheet) throw new Error("Source sheet 'M LUNA' was not found.");
...
function applyMLunaProtection_() {
  ...
  if (!sheet) throw new Error("Source sheet 'M LUNA' was not found.");
  ...
  const protection = sheet.protect().setDescription('Lock full M LUNA sheet');
