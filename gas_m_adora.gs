// ==================================================
// SECURE ENTRY - M ADORA (BACKEND - SEARCH + SYNC MIRROR)
// ==================================================
...
const SPREADSHEET_ID_FALLBACK = "1MiSrMDBlT6QvFdTDCZP2VsxrnO1MyaWLLLRF1zr66J4";
const DRIVE_FOLDER_ID = "1tvIdadC9_yFC9B-3xr9hkc5-wEP_xCVl";
const SYNC_TOKEN = "MA_SYNC_9f3c1a7b2d4e6f8091ab3cd5ef678901R";
