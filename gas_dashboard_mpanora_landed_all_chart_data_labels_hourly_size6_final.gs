...
function buildCharts_(sheet, stats) {
  ...
  const hourlyMax = roundUpToStep_(addChartHeadroom_(maxHourly, 0.2), hourlyStep);
  const monthlyMax = roundUpToStep_(addChartHeadroom_(maxMonthly, 0.2), monthlyStep);
  const categoryMax = roundUpToStep_(addChartHeadroom_(maxCategory, 0.2), categoryStep);
  ...
  const charts = [
    sheet.newChart()
      ...
      .setOption('series', {
        0: { color: '#4285F4', dataLabel: 'value', dataLabelFontSize: hourlyLabelFontSize }
      })
    ...
    sheet.newChart()
      ...
      .setOption('dataLabel', 'value')
      .setOption('series', {
        0: { color: '#DB4437', dataLabel: 'value' },
        1: { color: '#4285F4', dataLabel: 'value' },
        2: { color: '#F4B400', dataLabel: 'value' }
      })
      .setOption('vAxis', {
        textStyle: { fontSize: 10 },
    ...
    sheet.newChart()
      ...
      .setOption('dataLabel', 'value')
      .setOption('series', {
        0: { color: '#4285F4', dataLabel: 'value' }
      })
      .setOption('hAxis', {
